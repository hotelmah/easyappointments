 ...
 */
?>
<div id="footer" class="d-lg-flex justify-content-lg-start align-items-lg-center p-2 text-center text-lg-left mt-auto bg-light">
    <div class="mb-3 me-lg-5 mb-lg-0">
        <img class="me-1" src="<?= base_url('assets/img/logo-16x16.png') ?>" alt="Easy!Appointments Logo">
        <span>&copy; <?= date('Y') ?> &nbsp; <?= vars('company_name') ?> <?= lang('appointments') ?></span>
    </div>
    ...
    <div class="ms-lg-auto bg-primary text-dark p-1 rounded">
