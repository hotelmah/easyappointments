...
<form id="login-form">
    <div class="mb-3 mt-2">
        ...
        <input type="text" id="username" placeholder="<?= lang('enter_username_here') ?>" class="form-control border border-primary" required/>
    </div>
    ...
    <div class="mb-5">
        ...
        <input type="password" id="password" placeholder="<?= lang('enter_password_here') ?>" class="form-control border border-primary" required/>
    </div>
