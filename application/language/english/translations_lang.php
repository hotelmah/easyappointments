...
$lang['page_title_modify'] = 'Modify Appointment';
...
$lang['appointment_date_and_time_title'] = 'Hello and welcome to ' . setting('company_name') . ' Appointments. To {$book_modify} an appointment, please select a Date & Time and click next to continue.';
...
$lang['customer_information_title'] = 'Please {$complete_modify} the form below and click next to continue. Fields with an * are required.';
$lang['first_name'] = 'First Name';
$lang['last_name'] = 'Last Name';
$lang['email'] = 'eMail';
$lang['work_phone_number'] = 'Work Phone Number';
$lang['phone'] = 'Phone';
...
$lang['modified_fields_red'] = 'Please note: modified fields are highlighted in red.';
$lang['appointment_confirmation'] = 'Appointment Confirmation';
$lang['appointment_confirmation_title'] = 'Please review the information below. If everything looks good, click {$confirm_update} to proceed with Appointment {$confirmation_modification}.';
$lang['confirm'] = 'Confirm';
$lang['confirmation'] = 'Confirmation';
$lang['update'] = 'Update';
$lang['cancel_appointment_hint'] = 'Press the "Cancel" button to remove the appointment from the company schedule.';
$lang['cancel'] = 'Cancel';
$lang['appointment_registered'] = 'Your appointment has been successfully booked!';
...
$lang['customer_appointment_cancelled_title'] = 'Your Appointment has been Cancelled';
$lang['provider_appointment_cancelled_title'] = 'Your Customer\'s Appointment has been Cancelled';
$lang['admins_appointment_cancelled_title'] = 'An Appointment has been Cancelled';
$lang['reason'] = 'Reason';
$lang['no_link'] = 'The Appointment link no longer exists.';
$lang['fields_changed'] = 'The following fields were changed: ';
$lang['customer_fields_changed'] = 'Please review the fields highlighted in red below, as they have been changed.';
$lang['appointment_removed_from_schedule'] = 'The following appointment was removed from the company\'s schedule. Please see below for the reason.';
...
$lang['thank_you_for_appointment'] = 'Thank you for arranging an appointment with us. Below are all the appointment details. You can edit the appointment, reschedule or cancel, using the appointment link provided below.';
...
$lang['appointment_added_to_your_plan'] = 'A new appointment has been added to your schedule';
$lang['appointment_added_to_system'] = 'Notification of a new appointment';
...
$lang['appointment_does_not_exist_in_db'] = 'The appointment you requested does not exist in the company database anymore.';
...
$lang['undo'] = 'Undo';
$lang['customer_appointment_details_changed'] = 'Your booked appointment details have changed';
$lang['provider_appointment_details_changed'] = 'Your customer\'s booked appointment has changed';
$lang['admins_appointment_details_changed'] = 'A customer\'s booked appointment has changed';
...
$lang['default_working_plan'] = 'Default Working Plan';
...
$lang['sunday'] = 'Sunday';
$lang['breaks'] = 'Breaks';
$lang['default_breaks'] = 'Default Breaks';
$lang['add_breaks_during_each_day'] = 'Add the working breaks during each day of the above working plan. During breaks the provider will not accept any appointments.';
$lang['day'] = 'Day';
$lang['days'] = 'Days';
...
$lang['edit_working_plan_hint'] = 'Mark below the days and hours that your company will accept appointments. You will be able to adjust appointments in non-working hours, but customers will not be able to book appointments by themselves in non-working periods. This working plan will be the default for every new provider record. You will be able to change each provider\'s plan separately by editing their record. After that you can add per provider break periods.';
$lang['edit_breaks_hint'] = 'Add the working breaks during each day. These breaks will be applied for all new providers.';
$lang['edit_default_breaks_hint'] = 'Add the default working breaks during each day. These default breaks will be applied for all new providers. Each provider record may be edited separately.';
$lang['book_advance_timeout'] = 'Book Advance Timeout';
$lang['book_advance_timeout_hint'] = 'Define the cutoff period (in minutes) before an appointment starts during which customers cannot reschedule or cancel. Changes by the customer are only allowed before this restriction begins.';
$lang['timeout_minutes'] = 'Cutoff Period (Minutes)';
...
$lang['backend_section'] = 'Admin Dashboard';
$lang['you_need_to_login'] = 'Welcome! You will need to login in order to view administration pages.';
...
$lang['new_password_sent_with_email'] = 'Your new password has been sent to you in an email. Please check your inbox and spam folders.';
$lang['new_account_password'] = 'Your Appointments Account New Password';
...
$lang['unexpected_issues_message'] = 'The operation could not complete due to an unexpected error. Please try again or start over.';
$lang['close'] = 'Close';
...
$lang['start_date_time'] = 'Start Date and Time';
$lang['end_date_time'] = 'End Date and Time';
...
$lang['username_already_exists'] = 'Username already exists. Please choose another.';
...
$lang['add_working_plan_exceptions_during_each_day'] = 'Add working plan exceptions, outside the above working plan. Add or remove a date.';
...
$lang['company_color_hint'] = 'The company color will be applied across the app so that the app uses your branding.';
...
$lang['blocked_periods_hint'] = 'Define periods of time where public bookings will be disabled for all providers company wide (e.g. closed dates, holidays etc.). Please use the Working Plan Exception feature to define exceptions like blocked periods and days off and additional hours for individual providers in the providers section.';
...
$lang['add_service_hint'] = 'Add a new service to the database.';
$lang['edit_service_hint'] = 'Edit the selected service in the database.';
$lang['delete_service_hint'] = 'Delete the selected service from the database.';
$lang['view'] = 'View';
$lang['search_services_placeholder'] = 'Search services by name or category...';
$lang['search_services_hint'] = 'Search Services';
$lang['booking_link_specific'] = 'Click to open booking page. Use as Private Service. Send to Customer.';
...
$lang['settings_save_top'] = 'Please remember to click save at the top to commit this change to the database.';
$lang['workplan_exceptions_date_hint'] = 'Please choose a date that this working plan exception applies to.';
$lang['working_not_working'] = 'Working / Not Working';
$lang['workplan_exception_start_end'] = 'Start / End Time (if working selected date)';
$lang['workplan_exception_breaks_date'] = 'Add working breaks for the selected date. During breaks the provider will not accept any appointments.';
...
$lang['search_admins_placeholder'] = 'Search admins by name, email or phone number...';
$lang['search_admins_hint'] = 'Search Admins';
$lang['add_admin_hint'] = 'Add a new admin to the database.';
$lang['edit_admin_hint'] = 'Edit the selected admin in the database.';
$lang['delete_admin_hint'] = 'Delete the selected admin from the database.';
$lang['settings_menu'] = 'Settings Menu';
$lang['search_blocked_periods_placeholder'] = 'Search blocked periods by date or provider...';
$lang['search_blocked_periods_hint'] = 'Search Blocked Periods';
$lang['add_blocked_period_hint'] = 'Add a new blocked period to the database.';
$lang['edit_blocked_period_hint'] = 'Edit the selected blocked period in the database.';
$lang['delete_blocked_period_hint'] = 'Delete the selected blocked period from the database.';
$lang['search_webhooks_placeholder'] = 'Search webhooks by name or URL...';
$lang['search_webhooks_hint'] = 'Search Webhooks';
$lang['add_webhook_hint'] = 'Add a new webhook to the database.';
$lang['edit_webhook_hint'] = 'Edit the selected webhook in the database.';
$lang['delete_webhook_hint'] = 'Delete the selected webhook from the database.';
// End
